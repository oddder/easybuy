...
import com.odder.goods.service.SpecService;
...
public class SpecController {
     ...
     * 根据分类找参数
     * @param id
     * @return entity.Result<java.util.List<com.odder.goods.pojo.Spec>>
     * @date 21:06 2019/12/21
     * @author Odder
     **/
    @GetMapping("/category/{id}")
    public Result<List<Spec>> findByCategoryId(@PathVariable int id){
        List<Spec> byCategoryId = specService.findByCategoryId(id);
        return new Result<>(true,StatusCode.OK,"chenggong",byCategoryId);
    }
