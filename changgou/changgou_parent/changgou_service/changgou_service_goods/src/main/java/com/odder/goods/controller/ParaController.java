...
public class ParaController {
     ...
     * 根据分类找到参数
     * @param id
     * @return entity.Result<java.util.List<com.odder.goods.pojo.Para>>
     * @date 21:31 2019/12/21
     * @author Odder
     **/
    @GetMapping(value = "/category/{id}")
    public Result<List<Para>> findByCategory(@PathVariable int id){
        List<Para> byCategory = paraService.findByCategory(id);
        return new Result<>(true,StatusCode.OK,"成功",byCategory);
    }
